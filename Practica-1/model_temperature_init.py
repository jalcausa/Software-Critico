...
# Cargar los datos
df = pd.read_csv("nba.csv",index_col=0,parse_dates=True)
...
# Podemos decir que los datos que tengan error mayor a dos o tres veces el MAE sean anomalías
# mae = np.mean(mae)
...
# Nota de clase: para añadir un posible parámetro adicional podemos usar día de la semana o mes
